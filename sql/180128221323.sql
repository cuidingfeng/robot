...
INSERT INTO `sensor_case` VALUES ('6','27','1','传感器one1235','传感器one传感器one3455666','1'), ('7','33','1','传感器2','传感器22222','1'), ('8','35','2','myHttp-a','第一个http实例','1'), ('9','35','2','HttpDemo-b','第二个','1'), ('14','36','2','正式定时器','正式定时器','0'), ('15','36','2','aaaaa','sdfsdfsdf','1');
INSERT INTO `sensor_case_attr` VALUES ('1','6','11','http://www.koolearn.com/index'), ('5','7','13','1111111111'), ('6','7','14','可就玩完了'), ('7','6','12','3044599'), ('12','7','15','gdgdfgdfgg'), ('13','4','15','cuidingfeng'), ('14','9','16','http://rss.infoq.com'), ('15','8','16','http://rss.75team.com'), ('20','14','17','*/2 * * * * *'), ('21','15','17','003333');
...
INSERT INTO `status` VALUES ('1','1','冲顶夺顶替','abcdefg','匣9999','冲顶夺顶替冲顶夺顶替冲顶夺顶替'), ('2','1','二二奇才压下','2222','erererer','二二奇才压下'), ('8','1','44444444','44444','4444','44444444'), ('9','1','33333','33','3333','333'), ('10','1','999','999','ddddd','33'), ('11','2','第几次接收事件','changeNum','82','每次接收到事件，就加一'), ('12','2','test','varTest','ok','test and test');
